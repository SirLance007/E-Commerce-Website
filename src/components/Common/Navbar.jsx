        ...
        <>
            <nav className='container mx-auto flex items-center justify-between py-4 px-6 '>
                ...
                <div className='hidden md:flex space-x-6'>
                    <Link to= "#" className='text-grey-700 hover:text-black text-small font-medium uppercase'>
                        Men
                    </Link>
                    <Link to= "#" className='text-grey-700 hover:text-black text-small font-medium uppercase'>
                        Women
                    </Link><Link to= "#" className='text-grey-700 hover:text-black text-small font-medium uppercase'>
                        Top Wear
                    </Link><Link to= "#" className='text-grey-700 hover:text-black text-small font-medium uppercase'>
                        Bottom Wear
                    </Link>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <button onClick={toggleNavDrawer} className=''>
                        <HiBars3BottomRight  className=' md:hidden h-10 w-6 text-gray-700'/>
                    </button>
                </div>  
            </nav>
